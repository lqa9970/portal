...
Write-Host "Jiihaa!"
Write-Host "$Env:STORAGE_KEY"	
Write-Host "$Env:STORAGE_ACCOUNT"
Write-Host "$STORAGE_KEY"
Write-Host "Loppu"

$context = New-AzStorageContext -StorageAccountName $Env:STORAGE_ACCOUNT -StorageAccountKey $Env:STORAGE_KEY
