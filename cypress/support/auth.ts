import { decode, JwtPayload, ExternalTokenResponse } from 'jsonwebtoken'
...
const apiScopes = [`${backendIdentifier}/user_impersonation`]
...
const buildRefreshTokenEntity = (homeAccountId: string, secret: string) => ({
  clientId,
